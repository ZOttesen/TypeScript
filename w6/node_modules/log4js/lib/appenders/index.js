...
const adapters = require('log4js/lib/appenders/adapters');

// pre-load the core appenders so that webpack can find them
const coreAppenders = new Map();
coreAppenders.set('console', require('log4js/lib/appenders/console'));
coreAppenders.set('stdout', require('log4js/lib/appenders/stdout'));
coreAppenders.set('stderr', require('log4js/lib/appenders/stderr'));
coreAppenders.set('logLevelFilter', require('log4js/lib/appenders/logLevelFilter'));
coreAppenders.set('categoryFilter', require('log4js/lib/appenders/categoryFilter'));
coreAppenders.set('noLogFilter', require('log4js/lib/appenders/noLogFilter'));
coreAppenders.set('file', require('log4js/lib/appenders/file'));
coreAppenders.set('dateFile', require('log4js/lib/appenders/dateFile'));
coreAppenders.set('fileSync', require('log4js/lib/appenders/fileSync'));
coreAppenders.set('tcp', require('log4js/lib/appenders/tcp'));
